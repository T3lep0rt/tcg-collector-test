...
const CardGrid = ({ cards, loading, onCardClick }) => {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-400">Start building your collection!</p>
        </div>
      </div>
    );
  }
          ...
          <div className="bg-gradient-to-r from-slate-800/50 to-purple-900/50 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center">
                ...
                <div className="text-gray-400 text-sm mt-1">Total Cards</div>
              </div>
              <div className="text-center">
